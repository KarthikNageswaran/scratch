...
create table `nathanlane`.`people` (
  ...
  , ppl_active tinyint(1) not null default 1 comment 'FLAG TO DEFINE WHETHER RECORD IS ACTIVE 1=TRUE, 0=FALSE'
  , ppl_address1 varchar(32) not null comment 'ADDRESS LINE ONE'
  , ppl_address2 varchar(32) comment 'ADDRESS LINE TWO'
